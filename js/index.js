...
var destinations = [
	'12:39  LONDON      CL903     DELAYED',
	'12:57  PARIS       UQ5723    DELAYED',
	'13:08  MADRID      IC5984    DELAYED',
	'13:21  SIDNEY      AM608     DELAYED',
	'13:37  BRUSSELS    IC5471    DELAYED',
	'14:19  AMSTERDAM   EK3941    DELAYED',
	'17:00  KAILUA      MM060118  ON TIME',
	'17:47  BUDAPEST    AM5021    DELAYED',
	'18:12  NOVA DELHI  ON997     DELAYED',
	'19:00  BANGKOK     RI5324    DELAYED'
];
...
var shuffle = function(arr) {
	var main = 6;
	var others = arr.slice(0, main).concat(arr.slice(main+1));
	console.log('others', others);

	var res = shuffleArr(others);
	console.log('oi?', res);
	return res.splice(main, 0, '17:00     KAILUA      MM060218    ON TIME');
};

var board = new DepartureBoard (document.getElementById ('test'), { rowCount: destinations.length, letterCount: destinations[0].length }); 
